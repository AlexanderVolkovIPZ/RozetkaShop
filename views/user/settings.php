                    ...
                    <div class="col-4">
                        ...
                        <div class="firstName mt-2">
                            ...
                            <input type="text" name="firstName" id="firstNameEdit"
                                   class="w-100 d-none firstNameInput form-control">
                        </div>
                    </div>
                    <div class="col-4">
            ...
            <div class="accordion-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="loginWrapper d-flex align-items-center gx-2">
                        ...
                        <input class="w-50 form-control loginChange" type="text" id="login" name="loginUserEdit"
                               value="<?= $user['login'] ?>">
            ...
            <div class="accordion-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="d-inline-block">
                        ...
                        <input type="password" id="inputPassword2" name="passwordRepeat"
                               class="form-control editPassword2"
                               aria-describedby="passwordHelpInline">
