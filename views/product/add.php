...
<form action="" method="post"  enctype="multipart/form-data" class="container">
    ...
    <div class="mt-3">
        ...
        <textarea class="form-control ckeditor" name="brief_description" id="brief_description" cols="30" rows="5"></textarea>
    ...
    <div class="mt-3">
        ...
        <textarea class="form-control ckeditor" name="full_description" id="full_description" cols="30" rows="10"></textarea>
    ...
    <div class="mt-3">
        ...
        <input class="form-control fieldSelectorProduct" multiple type="file" name="file[]" id="formFile" accept="image/jpeg">
    </div>
...
<!--['count','name','price','id_category','brief_description','full_description','visibility']-->