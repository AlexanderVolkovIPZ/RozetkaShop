                ...
                <?php if ($product['count'] > 0): ?>
                    <div>
                        <a href="" data-id="<?= $product['id'] ?>"
                           class="btn btn-success btnAddProductToBasket <?php if ($user['typeAccess'] == 10) echo "disabled" ?>">


                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart-check productInBasket
<?php if (empty($_SESSION['basket'][$product['id']])): ?>
    <?= "d-none" ?>
<?php endif; ?>
" viewBox="0 0 16 16">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                 class="bi bi-cart2 productInBasketNot
                                 <?php if (!empty($_SESSION['basket'][$product['id']])): ?>
                                    <?= "d-none" ?>
                                <?php endif; ?>
" viewBox="0 0 16 16">
                ...
                <?php else: ?>
                    <div>
                        <a href="" class="btn btn-secondary btnAddProductToBasket disabled">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" id="commentForm" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea class="form-control commentArea" placeholder="Написати..."
                                                      name="comment"
                                                      id="comment"></textarea>
                ...
                <div class="mt-3 commentWrapper">
                    ...
                    <?php foreach ($comments as $comment): ?>
                        <div class="alert alert-light" role="alert" style="padding-top: 0">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                                         class="bi bi-cart-check-fill iconCommentBought" viewBox="0 0 16 16">
                            ...
                            <hr class="my-2">
                            <div class="mt-3">
                                <div class="d-flex justify-content-start scoreReiting"
                                     data-reiting="<?= $comment['reiting'] ?>">
